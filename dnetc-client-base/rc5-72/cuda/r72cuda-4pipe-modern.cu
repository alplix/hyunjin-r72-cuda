 ...
 * Modernized for Ampere (CC 8.x), Hopper (CC 9.x), Blackwell (CC 10.x) GPUs
 *
 * $Id: r72cuda-4pipe-modern.cu,v 1.20 2012/01/13 01:05:39 snikkel Exp $
*/
...
#error Only CUDA SDK version 11.0 or higher are supported for modern GPUs.
#endif

#ifdef __cplusplus
extern "C" s32 CDECL rc5_72_unit_func_cuda_4_modern( RC5_72UnitWork *, u32 *, void * );
extern "C" s32 CDECL rc5_72_unit_func_cuda_4_modern_512( RC5_72UnitWork *, u32 *, void * );
extern "C" s32 CDECL rc5_72_unit_func_cuda_4_modern_1024( RC5_72UnitWork *, u32 *, void * );
#endif

static __global__ void cuda_4pipe_modern(const u32 plain_hi, const u32 plain_lo,
...
static s32 CDECL rc5_72_run_cuda_4_modern(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, int device, u32 num_threads, int waitmode);
...
s32 CDECL rc5_72_unit_func_cuda_4_modern(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, void * /*memblk*/)
{
  return rc5_72_run_cuda_4_modern(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, MODERN_CUDA_BLOCK_SIZE, default_wait_mode);
}

s32 CDECL rc5_72_unit_func_cuda_4_modern_512(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, void * /*memblk*/)
{
  return rc5_72_run_cuda_4_modern(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, 512, default_wait_mode);
}

s32 CDECL rc5_72_unit_func_cuda_4_modern_1024(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, void * /*memblk*/)
{
  return rc5_72_run_cuda_4_modern(rc5_72unitwork, iterations, rc5_72unitwork->devicenum, 1024, default_wait_mode);
}

static s32 CDECL rc5_72_run_cuda_4_modern(RC5_72UnitWork *rc5_72unitwork, u32 *iterations, int device, u32 num_threads, int waitmode)
{
  const u32 pipeline_count = MODERN_CUDA_PIPELINE_COUNT;
  const u32 max_grid_dim = 65535;
  const u32 optimal_process_amount = num_threads * max_grid_dim * pipeline_count;
  ...
  for (i = 0; i < *iterations; i += optimal_process_amount) {
    ...
    cuda_4pipe_modern<<<grid_dimension, block_dimension, 0, core>>>(
...
__global__ void cuda_4pipe_modern(const u32 plain_hi, const u32 plain_lo,
                                  const u32 cypher_hi, const u32 cypher_lo,
                                  const u32 L0_hi, const u32 L0_mid, const u32 L0_lo,
                                  const u32 process_amount, u8 * results, u8 * match_found)
{
  const int pipeline_count = MODERN_CUDA_PIPELINE_COUNT;
  int k;
