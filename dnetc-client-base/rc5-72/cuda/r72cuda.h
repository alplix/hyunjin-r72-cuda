...
/* Modern CUDA kernel configurations */
#if !defined(MODERN_CUDA_BLOCK_SIZE)
#define MODERN_CUDA_BLOCK_SIZE 256
#endif

#if !defined(MODERN_CUDA_PIPELINE_COUNT)
#define MODERN_CUDA_PIPELINE_COUNT 4
#endif

// Compute capability detection for modern GPUs
#if defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 800
#define MODERN_CUDA_AMPERE_OR_LATER 1
#else
#define MODERN_CUDA_AMPERE_OR_LATER 0
#endif

#if defined(__CUDA_ARCH__) && __CUDA_ARCH__ >= 900
#define MODERN_CUDA_HOPPER_OR_LATER 1
#else
#define MODERN_CUDA_HOPPER_OR_LATER 0
#endif
